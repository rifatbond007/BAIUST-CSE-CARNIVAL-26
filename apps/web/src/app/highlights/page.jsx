    ...
    <div className="relative">
      ...
      <div className="hidden lg:flex items-start">
        <div className={`w-[calc(50%-28px)] ${isLeft ? "" : "ml-auto"}`}>
          ...
          >
            <CardContent fest={fest} expanded={expanded} setExpanded={setExpanded} index={index} />
          </motion.div>
        </div>
        <div className="w-14 flex-shrink-0 flex flex-col items-center">
          <motion.div
            ...
            className="w-10 h-10 rounded-full bg-[#2E3A2E] text-white text-sm font-black flex items-center justify-center shadow-md z-10 relative ring-4 ring-[#F5F5F5]"
          >
            {fest.year.slice(2)}
          </motion.div>
        </div>
...
function CardContent({ fest, expanded, setExpanded, index }) {
  return (
    <div
      className="bg-white border border-gray-100 rounded-xl p-6 shadow-sm cursor-pointer transition-all duration-300 hover:border-[#2E3A2E]/15 hover:shadow-md"
      onClick={() => setExpanded(!expanded)}
    >
      {/* Header */}
      <div className="flex items-start justify-between mb-4">
        <div className="space-y-1">
          <div className="text-[#2E3A2E]/30 text-[10px] font-bold uppercase tracking-widest mb-1">
            Edition {fest.year}
          </div>
        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-black text-[#2E3A2E] leading-none">
              How We
              <br />
              <span className="text-[#2E3A2E]/30">Grew</span>
            </h2>
          </motion.div>

          <div className="relative max-w-4xl mx-auto">
            {/* Central line */}
            <div className="hidden lg:block absolute left-1/2 top-8 bottom-8 w-0.5 bg-[#2E3A2E]/40 -translate-x-1/2" />
